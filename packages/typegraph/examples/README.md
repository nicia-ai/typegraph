...
| [31-ordered-collections.ts](./31-ordered-collections.ts) | Ordered, filtered scalar collections over optional child rows, including childless parent groups, typed preparation, and batching |
