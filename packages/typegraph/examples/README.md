...
| [31-ordered-collections.ts](./31-ordered-collections.ts) | Ordered scalar collections and top-N record collections per parent, including childless groups, typed preparation, and batching |
