...
// @public
export type BulkFindRuntimeEdgesFromResult<NT extends RuntimeNodeKind, ET extends RuntimeEdgeKind> = Readonly<{
...
// @public
type BundleVerdictOf<D extends CapabilityBundleDefinition> = D extends ({
    kind: "graduated";
...
// @public (undocumented)
type CapabilityBundleDefinition = GatedBundleDefinition<OptionalGraphBackendMember, string, OptionalGraphBackendMember> | GraduatedBundleDefinition<string, OptionalGraphBackendMember>;
...
// @public
type CapabilityBundleExtra<Id extends string, M extends OptionalGraphBackendMember> = Readonly<{
    id: Id;
    members: readonly M[];
...
// @public
type CapabilityBundleOperation = Readonly<{
    operation: string;
    disposition: CapabilityBundleDisposition;
...
// @public
type CapabilityBundleOperationSite = Readonly<{
    file: string;
...
// @public
export const compareAndSetAbsent: unique symbol;

// @public
export type CompareAndSetExpected<Props> = Readonly<{
    [Property in keyof Props]?: Extract<Exclude<Props[Property], undefined>, JsonScalar> | CompareAndSetAbsent;
}>;
...
// @public (undocumented)
type DynamicEdgeTypeFor<T> = T extends RuntimeEdgeKind ? RuntimeEdgeTypeFor<T> : DynamicEdgeType;
...
// @public (undocumented)
type DynamicNodeTypeFor$1<T> = T extends RuntimeNodeKind ? RuntimeNodeTypeFor<T> : DynamicNodeType;

// @public (undocumented)
type DynamicNodeTypeFor<T> = T extends RuntimeNodeKind ? RuntimeNodeTypeFor<T> : DynamicNodeType;
...
// @public
type EdgeAllowedPairs<R extends EdgeRegistration> = ExtractAllowedPairs<R["from"], R["to"]>;
...
// @public (undocumented)
type EdgeBulkCreateItem<Pairs extends EdgeEndpointPairTypes, Schema extends z.ZodObject<z.ZodRawShape>> = Pairs extends EdgeEndpointPairTypes ? Readonly<{
...
// @public (undocumented)
type EdgeBulkGetOrCreateItem<E extends AnyEdgeType, Pairs extends EdgeEndpointPairTypes> = Pairs extends EdgeEndpointPairTypes ? Readonly<{
    from: NodeRef<Pairs["from"]>;
    to: NodeRef<Pairs["to"]>;
...
// @public (undocumented)
type EdgeBulkInsertItem<Pairs extends EdgeEndpointPairTypes, Schema extends z.ZodObject<z.ZodRawShape>> = Pairs extends EdgeEndpointPairTypes ? Readonly<{
    from: NodeRef<Pairs["from"]>;
    to: NodeRef<Pairs["to"]>;
    props?: z.input<Schema>;
    id?: string;
...
// @public (undocumented)
type EdgeCreateArgumentsTuple<E extends AnyEdgeType, Pairs extends EdgeEndpointPairTypes> = Pairs extends EdgeEndpointPairTypes ? [
from: NodeRef<Pairs["from"]>,
to: NodeRef<Pairs["to"]>,
...
// @public (undocumented)
type EdgeFindByEndpointsArguments<E extends AnyEdgeType, Pairs extends EdgeEndpointPairTypes> = Pairs extends EdgeEndpointPairTypes ? [
from: NodeRef<Pairs["from"]>,
to: NodeRef<Pairs["to"]>,
...
// @public (undocumented)
type EdgeGetOrCreateByEndpointsArguments<E extends AnyEdgeType, Pairs extends EdgeEndpointPairTypes> = Pairs extends EdgeEndpointPairTypes ? [
from: NodeRef<Pairs["from"]>,
to: NodeRef<Pairs["to"]>,
props: z.input<E["schema"]>,
...
// @public
export type EmbeddableOneStatementRead<R> = OneStatementBatchableQuery<R> & (BatchableQuery<unknown> | Required<Pick<OneStatementBatchableQuery<R>, "compileOneStatementBatchItem">>);
...
export class EndpointPairError extends TypeGraphError {
    constructor(details: Readonly<{
        ...
        fromKind: string;
        toKind: string;
        allowedPairs: readonly Readonly<{
            from: string;
            to: string;
        }>[];
    }>, options?: {
    ...
    // (undocumented)
    readonly details: EndpointPairErrorDetails;
}
...
// @public
export type ExecutableOneStatementRead<R> = EmbeddableOneStatementRead<R> & Required<Pick<OneStatementBatchableQuery<R>, "execute">>;
...
// @public
type ExtensionEdgeProperties<D extends ExtensionEdgeDef> = D extends (Readonly<{
...
// @public
type ExtensionObjectOutput<P extends Readonly<Record<string, ExtensionPropertyType>>> = Readonly<{
...
// @public
type ExtensionObjectSchema<P extends Readonly<Record<string, ExtensionPropertyType>>> = z.ZodObject<{
...
// @public
type ExtensionPropertyOutput<P extends ExtensionPropertyType> = P extends {
    optional: true;
...
type ExtractAllowedPairs<From, To> = To extends readonly (infer ToNode extends NodeType)[] ? {
    from: From extends readonly (infer FromNode extends NodeType)[] ? FromNode : NodeType;
    to: ToNode;
} : To extends Record<string, readonly NodeType[]> ? {
    [K in keyof To & string]: {
        from: Extract<From extends readonly (infer FromNode extends NodeType)[] ? FromNode : NodeType, {
            kind: K;
        }>;
        to: To[K] extends readonly (infer ToNode extends NodeType)[] ? ToNode : NodeType;
    };
}[keyof To & string] : {
    from: NodeType;
    to: NodeType;
...
// @public (undocumented)
type ExtractTargets<T> = T extends readonly (infer N extends NodeType)[] ? N : T extends Record<string, readonly (infer N extends NodeType)[]> ? N : never;

// @public
type ExtraVerdict<M extends OptionalGraphBackendMember> = Readonly<{
    present: true;
    members: readonly M[];
}> | Readonly<{
    present: false;
...
// @public
type ExtraVerdicts<X extends CapabilityExtraSpec> = Readonly<{
...
// @public
type GatedBundleDefinition<MCore extends OptionalGraphBackendMember, XId extends string = never, MExtra extends OptionalGraphBackendMember = never> = CapabilityBundleCommon & Readonly<{
    kind: "gated";
    core: readonly MCore[];
...
// @public (undocumented)
type GatedBundleVerdict<MCore extends OptionalGraphBackendMember, X extends CapabilityExtraSpec> = Readonly<{
    supported: true;
    bundle: string;
...
// @public
type GraduatedBundleDefinition<XId extends string, MExtra extends OptionalGraphBackendMember> = CapabilityBundleCommon & Readonly<{
    kind: "graduated";
    extras: readonly CapabilityBundleExtra<XId, MExtra>[];
}>;

// @public
type GraduatedBundleVerdict<X extends CapabilityExtraSpec> = Readonly<{
    bundle: string;
    extras: ExtraVerdicts<X>;
    missingExtras: readonly (keyof X)[];
}>;
...
export type GraphEdgeForKinds<G extends GraphDef, K extends EdgeKinds<G>> = {
    [P in K]: Edge<G["edges"][P]["type"], G["edges"][P]["from"][number], G["edges"][P]["to"] extends readonly (infer N extends NodeType)[] ? N : G["edges"][P]["to"] extends (Record<string, readonly (infer N extends NodeType)[]>) ? N : NodeType>;
}[K];
...
export class GraphExtensionUnresolvedOntologyEndpointError extends GraphExtensionError {
    constructor(metaEdge: "inverseOf" | "implies", endpoint: string, graphId: string);
    // (undocumented)
    readonly code: "GRAPH_EXTENSION_UNRESOLVED_ONTOLOGY_ENDPOINT";
    // (undocumented)
    readonly endpoint: string;
    // (undocumented)
...
// @public (undocumented)
export type IdentityAssertionId = string & Readonly<{
...
export class IdentityContradictionError extends TypeGraphError {
    ...
    // (undocumented)
    readonly details: IdentityContradictionErrorDetails;
}
...
// @public (undocumented)
export type NeighborRead<G extends GraphDef, K extends EdgeKinds<G>> = ExecutableOneStatementRead<readonly NeighborResult<G, K>[]>;
...
export type NodeCollection<N extends NodeType, CN extends string = string> = Readonly<{
    ...
    compareAndSet: (id: NodeId<N>, params: Readonly<{
...
// @public (undocumented)
export type NodeCollectionLookup = <const K extends string>(kind: K) => DynamicNodeCollection<K> | undefined;
...
export class QueryBuilder<G extends GraphDef, Aliases extends AliasMap = EmptyAliasMap, EdgeAliases extends EdgeAliasMap = EmptyEdgeAliasMap, RecursiveAliases extends RecursiveAliasMap = EmptyRecursiveAliasMap, CoordinateState extends QueryCoordinateState = "open"> {
    ...
    optionalTraverseDynamic<T extends string | RuntimeEdgeKind, EA extends string>(edgeKind: T, edgeAlias: EA, options?: {
    ...
    traverseDynamic<T extends string | RuntimeEdgeKind, EA extends string>(edgeKind: T, edgeAlias: EA, options?: {
        direction?: TraversalDirection_2;
        expand?: TraversalExpansion;
        from?: keyof Aliases & string;
...
// @public
export function rebuildIdentityClosure<G extends GraphDef & Readonly<{
    identity: GraphIdentityConfig;
...
// @public (undocumented)
export const RecordedStoreView: new <G extends GraphDef>(store: Store<G>, coordinate: ReadCoordinate) => RecordedStoreView<G>;

// @public
export type RecordedStoreViewEdgeCollection<E extends AnyEdgeType, From extends NodeType = NodeType, To extends NodeType = NodeType, Pairs extends EdgeEndpointPairTypes = {
    from: From;
    to: To;
}> = Pick<StoreViewEdgeCollection<E, From, To, Pairs>, (typeof RECORDED_POINT_READ_NAMES)[number]> & Readonly<{
...
// @public (undocumented)
const RUNTIME_KIND_TOKEN_BRAND: unique symbol;

// @public
export type RuntimeBulkEdgeSourceGroup<T extends RuntimeNodeKind> = T extends RuntimeNodeKind ? Readonly<{
    kind: T;
    ids: readonly string[];
}> : never;
...
// @public
export type RuntimeEdgeKind<K extends string = string, S extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = Readonly<{
    entity: "edge";
    kind: K;
...
// @public
export type RuntimeEdgeTypeFor<T extends RuntimeEdgeKind> = T extends RuntimeEdgeKind<infer K, infer S> ? EdgeType<K, S, readonly NodeType[] | undefined, readonly NodeType[] | undefined> : never;

// @public
export class RuntimeKindTokenError extends TypeGraphError {
    constructor(reason: RuntimeKindTokenFailure, entity: KindEntity, details?: Readonly<Record<string, unknown>>);
    // (undocumented)
    readonly reason: RuntimeKindTokenFailure;
}

// @public (undocumented)
export type RuntimeKindTokenFailure = "invalid" | "wrong-entity" | "wrong-kind" | "wrong-store" | "stale" | "schema-mismatch" | "unreconciled";

// @public
export type RuntimeNodeCollection<T extends RuntimeNodeKind> = WidenBrandedIds<NodeCollection<RuntimeNodeTypeFor<T>, string>>;

// @public
export type RuntimeNodeKind<K extends string = string, S extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = Readonly<{
    entity: "node";
    kind: K;
    [RUNTIME_KIND_TOKEN_BRAND]: S;
}>;
...
// @public
export type RuntimeNodeReferenceFor<T extends RuntimeNodeKind> = T extends RuntimeNodeKind ? Readonly<{
    kind: T["kind"];
...
export class StoreAnalysisCursorStaleError extends TypeGraphError {
    ...
    // (undocumented)
    readonly details: StoreAnalysisCursorStaleErrorDetails;
}
...
type StoreCore<G extends GraphDef> = Readonly<{
    ...
    runtimeNodeKind: <const K extends string, const D extends ExtensionNodeDef>(kind: K, definition: D) => RuntimeNodeKind<K, ExtensionObjectSchema<D["properties"]>>;
...
// @public
export type StoreView<G extends GraphDef> = StoreViewImplementation<G> & ViewIdentityAccess<G>;

// @public (undocumented)
export const StoreView: new <G extends GraphDef>(store: Store<G>, coordinate: StoreViewCoordinate | ReadCoordinate) => StoreView<G>;
...
// @public
export type StoreViewEdgeCollection<E extends AnyEdgeType, From extends NodeType = NodeType, To extends NodeType = NodeType, Pairs extends EdgeEndpointPairTypes = {
    from: From;
    to: To;
}> = Readonly<{
    ...
    findByEndpoints: (...args: Pairs extends EdgeEndpointPairTypes ? [
    from: NodeRef<Pairs["from"]>,
    to: NodeRef<Pairs["to"]>,
    options?: EdgeFindByEndpointsOptions<E>
    ] : never) => Promise<Edge<E, From, To> | undefined>;
}>;
...
// @public
export type SubgraphRead<G extends GraphDef, NK extends NodeKinds<G>, EK extends EdgeKinds<G>, P extends SubgraphProject<G, NK, EK> | undefined = undefined> = ExecutableOneStatementRead<SubgraphResult<G, NK, EK, P>>;
...
// @public
export type TypedStoreViewEdgeCollection<R extends EdgeRegistration> = StoreViewEdgeCollection<R["type"], EdgeFromTypes<R> extends NodeType ? EdgeFromTypes<R> : NodeType, EdgeToTypes<R> extends NodeType ? EdgeToTypes<R> : NodeType, EdgeAllowedPairs<R>>;
