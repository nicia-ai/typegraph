...
// @public
export type NeighborReadOptions<G extends GraphDef, K extends EdgeKinds<G>> = Readonly<{
    edges: readonly K[];
...
// @public
export type OneStatementBatchResults<Queries extends readonly OneStatementBatchableQuery<unknown>[]> = {
