...
// @public
type AggregateResult<R extends Record<string, FieldRef | AggregateExpr>, Aliases extends AggregateAliasMap = AggregateAliasMap> = {
...
// @public
type BulkFindEdgesToParams<G extends GraphDef, K extends EdgeKinds<G>> = Readonly<{
    targets: readonly BulkEdgeSourceGroup<G>[];
    edgeKinds: readonly K[];
}>;

// @public
type BulkFindEdgesToResult<G extends GraphDef, K extends EdgeKinds<G>> = Readonly<{
    target: GraphNodeReference<G>;
    edges: readonly GraphEdgeForKinds<G, K>[];
}>;

// @public
type BulkFindRuntimeEdgesFromParams<NT extends RuntimeNodeKind, ET extends RuntimeEdgeKind> = Readonly<{
...
// @public
const compareAndSetAbsent: unique symbol;

// @public
type CompareAndSetExpected<Props> = Readonly<{
...
// @public
type ContributionProbeResult = Readonly<{
...
// @public (undocumented)
export function createRetractionCapability<G extends GraphDef, const C extends ProvenanceRetractionConfig<G>>(store: HistoryStore<G>, config: C): RetractionCapability<G, SourceKindsFromConfig<G, C>, FactKindsFromConfig<G, C>, JustificationKindFromConfig<G, C>>;
...
// @public
type DatabaseExpression<out T = unknown, out Scope extends string = string> = Readonly<{
...
// @public (undocumented)
type DatabaseProjection = Readonly<Record<string, DatabaseExpression>>;
...
// @public
class ExecutableProjectionQuery<Fields extends DatabaseProjection, Context, Result = ProjectionResult<Fields>> {
...
// @public (undocumented)
class ExecutableRelationQuery<Fields extends RelationProjection, Result = RelationProjectionResult<Fields>> {
...
// @public (undocumented)
type ExpressionAliasContext<Aliases extends AliasMap, Edges extends EdgeAliasMap, Scope extends string = (keyof Aliases | keyof Edges) & string> = {
...
// @public (undocumented)
type ExpressionValue<Value, Scope extends string> = DatabaseExpression<Exclude<Value, null> | (null extends Value ? undefined : never), Scope> & (NonNullable<Value> extends Date | readonly unknown[] ? unknown : NonNullable<Value> extends object ? ExpressionObjectChildren<Value, Scope> : unknown);
...
// @public (undocumented)
type FactKindsFromConfig<G extends GraphDef, C extends ProvenanceRetractionConfig<G>> = KindsFromRef<G, C["fact"]>;
...
// @public
type FieldRef<Value = unknown, Alias extends string = string, Path extends readonly string[] = readonly string[], PropertyPath extends readonly string[] = readonly string[]> = Readonly<{
    __type: "field_ref";
    alias: Alias;
    path: Path;
...
// @public
type GraphAnnotationsChange = Readonly<{
    type: ChangeType;
    severity: "safe";
    details: string;
}>;
...
// @public (undocumented)
type JustificationKindFromConfig<G extends GraphDef, C extends ProvenanceRetractionConfig<G>> = KindsFromRef<G, C["justification"]>;
...
// @public (undocumented)
type KindPopulationStatistics = Readonly<{
    entity: KindEntity;
    kind: string;
    count: number;
...
// @public
type KindsFromRef<G extends GraphDef, Ref> = Ref extends Readonly<{
    kind: infer K;
}> ? Extract<K, NodeKind<G>> : Ref extends Readonly<{
    kinds: readonly (infer K)[];
}> ? Extract<K, NodeKind<G>> : NodeKind<G>;
...
// @public (undocumented)
type NodeCollectionLookup = <const K extends string>(kind: K) => DynamicNodeCollection<K> | undefined;
...
// @public
type PreparedParameterDeclaration = Readonly<Record<string, DatabaseExpression>>;
...
// @public (undocumented)
type ProjectionResult<Fields extends DatabaseProjection> = {
...
// @public (undocumented)
export type ProvenanceFactRef<G extends GraphDef = GraphDef, K extends NodeKind<G> = NodeKind<G>> = ProvenanceNodeRef<G, K>;

// @public (undocumented)
export type ProvenanceJustificationRef<G extends GraphDef = GraphDef, K extends NodeKind<G> = NodeKind<G>> = ProvenanceNodeRef<G, K>;

// @public (undocumented)
export type ProvenanceNodeRef<G extends GraphDef = GraphDef, K extends NodeKind<G> = NodeKind<G>> = Readonly<{
    kind: K;
    id: string;
}>;

// @public (undocumented)
export type ProvenanceRetractionConfig<G extends GraphDef = GraphDef> = Readonly<{
...
// @public (undocumented)
type ProvenanceSourceConfig<G extends GraphDef = GraphDef> = Readonly<{
    kind: NodeKind<G>;
...
// @public
type RecordedStoreViewEdgeCollection<E extends AnyEdgeType, From extends NodeType = NodeType, To extends NodeType = NodeType, Pairs extends EdgeEndpointPairTypes = {
    from: From;
    to: To;
...
// @public
type RecursiveTraversalVerdict = Readonly<{
...
// @public (undocumented)
type RelationColumnContext<Fields extends RelationProjection> = {
...
// @public (undocumented)
type RelationProjection = Readonly<Record<string, DatabaseExpression>>;

// @public (undocumented)
type RelationProjectionResult<Fields extends RelationProjection> = {
    -readonly [Key in keyof Fields]: Fields[Key] extends (DatabaseExpression<infer Value>) ? Value : never;
};
...
// @public (undocumented)
interface RequiredNodeCollectionLookup {
    // (undocumented)
...
// @public (undocumented)
export type RetractionCapability<G extends GraphDef = GraphDef, SourceKind extends NodeKind<G> = NodeKind<G>, FactKind extends NodeKind<G> = NodeKind<G>, JustificationKind extends NodeKind<G> = NodeKind<G>> = Readonly<{
    retract: (source: ProvenanceNodeRef<G, SourceKind>) => Promise<RetractionReport<G, FactKind, JustificationKind>>;
    retractMany: (sources: readonly ProvenanceNodeRef<G, SourceKind>[]) => Promise<RetractionReport<G, FactKind, JustificationKind>>;
    unRetract: (source: ProvenanceNodeRef<G, SourceKind>) => Promise<RetractionReport<G, FactKind, JustificationKind>>;
    unRetractMany: (sources: readonly ProvenanceNodeRef<G, SourceKind>[]) => Promise<RetractionReport<G, FactKind, JustificationKind>>;
    holding: () => Promise<readonly ProvenanceFactRef<G, FactKind>[]>;
}>;

// @public (undocumented)
export type RetractionReport<G extends GraphDef = GraphDef, FactKind extends NodeKind<G> = NodeKind<G>, JustificationKind extends NodeKind<G> = NodeKind<G>> = Readonly<{
...
// @public
type RuntimeBulkEdgeSourceGroup<T extends RuntimeNodeKind> = T extends RuntimeNodeKind ? Readonly<{
    kind: T;
    ids: readonly string[];
}> : never;
...
// @public
type RuntimeEdgeKind<K extends string = string, S extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = Readonly<{
    entity: "edge";
    kind: K;
...
// @public
type RuntimeEdgeTypeFor<T extends RuntimeEdgeKind> = T extends RuntimeEdgeKind<infer K, infer S> ? EdgeType<K, S, readonly NodeType[] | undefined, readonly NodeType[] | undefined> : never;

// @public
type RuntimeNodeCollection<T extends RuntimeNodeKind> = WidenBrandedIds<NodeCollection<RuntimeNodeTypeFor<T>, string>>;

// @public
type RuntimeNodeKind<K extends string = string, S extends z.ZodObject<z.ZodRawShape> = z.ZodObject<z.ZodRawShape>> = Readonly<{
    entity: "node";
    kind: K;
    [RUNTIME_KIND_TOKEN_BRAND]: S;
}>;
...
// @public
type RuntimeNodeReferenceFor<T extends RuntimeNodeKind> = T extends RuntimeNodeKind ? Readonly<{
    kind: T["kind"];
    id: NodeId<RuntimeNodeTypeFor<T>>;
}> : never;

// @public
type RuntimeNodeTypeFor<T extends RuntimeNodeKind> = T extends RuntimeNodeKind<infer K, infer S> ? NodeType<K, S> : never;
...
// @public (undocumented)
type SourceKindsFromConfig<G extends GraphDef, C extends ProvenanceRetractionConfig<G>> = KindsFromRef<G, C["source"]>;
...
// @public (undocumented)
type StoreDescription = Readonly<{
...
// @public (undocumented)
type StoreValidationFailure = Readonly<{
    entity: KindEntity;
    kind: string;
    id: string;
    path: string;
...
// @public
type StoreViewEdgeCollection<E extends AnyEdgeType, From extends NodeType = NodeType, To extends NodeType = NodeType, Pairs extends EdgeEndpointPairTypes = {
    from: From;
    to: To;
}> = Readonly<{
...
// @public (undocumented)
export type SurvivedVia<G extends GraphDef = GraphDef, FactKind extends NodeKind<G> = NodeKind<G>, JustificationKind extends NodeKind<G> = NodeKind<G>> = Readonly<{
...
// @public
type TopPerPartitionOptions<Fields extends RelationProjection> = Readonly<{
...
// @public
type TopPerPartitionOrder = Readonly<{
    expression: DatabaseExpression;
    direction?: SortDirection;
    nulls?: "first" | "last";
}>;
...
// @public
type TypedEdgeCollection<R extends EdgeRegistration> = EdgeCollection<R["type"], EdgeFromTypes<R> extends NodeType ? EdgeFromTypes<R> : NodeType, EdgeToTypes<R> extends NodeType ? EdgeToTypes<R> : NodeType, EdgeAllowedPairs<R>>;

// @public
type TypedRecordedStoreViewEdgeCollection<R extends EdgeRegistration> = RecordedStoreViewEdgeCollection<R["type"], EdgeFromTypes<R> extends NodeType ? EdgeFromTypes<R> : NodeType, EdgeToTypes<R> extends NodeType ? EdgeToTypes<R> : NodeType, EdgeAllowedPairs<R>>;

// @public
type TypedStoreViewEdgeCollection<R extends EdgeRegistration> = StoreViewEdgeCollection<R["type"], EdgeFromTypes<R> extends NodeType ? EdgeFromTypes<R> : NodeType, EdgeToTypes<R> extends NodeType ? EdgeToTypes<R> : NodeType, EdgeAllowedPairs<R>>;
...
// @public (undocumented)
type ValidateStoreOptions = Readonly<{
    entity: KindEntity;
    kind: string;
    pageSize?: number;
    cursor?: string;
