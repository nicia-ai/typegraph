...
// @public
export function createLocalSqliteStore<G extends GraphDef>(graph: G, options?: LocalSqliteStoreOptions<UnboundLiveStoreOptions>): Promise<Store<G>>;

// @public (undocumented)
export function createLocalSqliteStore<G extends GraphDef>(graph: G, options: LocalSqliteStoreOptions<HistoryStoreOptions> & Readonly<{
    store: HistoryStoreOptions;
}>): Promise<HistoryStore<G>>;

// @public (undocumented)
export function createLocalSqliteStore<G extends GraphDef>(graph: G, options: LocalSqliteStoreOptions<RecordedReadStoreOptions> & Readonly<{
    store: RecordedReadStoreOptions;
}>): Promise<RecordedReadStore<G>>;

// @public (undocumented)
export function createLocalSqliteStore<G extends GraphDef>(graph: G, options: LocalSqliteStoreOptions<LiveStoreOptions>): Promise<Store<G> | RecordedReadStore<G>>;

// @public (undocumented)
export function createLocalSqliteStore<G extends GraphDef>(graph: G, options: LocalSqliteStoreOptions): Promise<Store<G> | HistoryStore<G> | RecordedReadStore<G>>;
...
// @public
type HistoryStoreOptions = BaseStoreOptions & Readonly<{
    history: true;
    recordedRead?: never;
}>;
...
// @public
export type LocalSqliteJournalMode = "wal" | "delete" | "truncate" | "persist" | "memory" | "off";
...
// @public (undocumented)
type RecordedReadStore<G extends GraphDef> = ResolvedStoreCore<G> & StoreTransactions<G> & StoreEvolution<G, RecordedReadStore<G>> & Readonly<{
    recordedReadBound: true;
}>;

// @public
type RecordedReadStoreOptions = LiveStoreOptions & Readonly<{
...
// @public
type StoreOptions = LiveStoreOptions | HistoryStoreOptions;
