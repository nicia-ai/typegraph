...
export function renderLedgerWalkModule(): string {
  return [
    ...
    "}",
    "",
    "function assertShippedLedgerPartitionsExports(shippedLedger) {",
    "  const expectations = loadExpectations();",
    "  assert.deepEqual(shippedLedger, expectations.ledger);",
    "",
    ...
    "",
    "module.exports = {",
    "  assertShippedLedgerPartitionsExports,",
    "  loadExpectations,",
    "  walkLedger,",
...
export function renderPortableEsmRunner(): string {
  return [
    ...
    'import { MISSING_PEER_LEDGER } from "@nicia-ai/typegraph/backend";',
    'import { z } from "zod";',
    "",
    ...
    "}",
    "",
    "assertShippedLedgerPartitionsExports(MISSING_PEER_LEDGER);",
    "",
...
export function renderPortableCjsRunner(): string {
  return [
    ...
    'const { MISSING_PEER_LEDGER } = require("@nicia-ai/typegraph/backend");',
    'const { z } = require("zod");',
    "const {",
    "  assertShippedLedgerPartitionsExports,",
    "  loadExpectations,",
